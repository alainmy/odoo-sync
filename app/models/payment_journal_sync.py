...
class PaymentJournalSync(Base):
    __tablename__ = "payment_journal_sync"

    id = Column(Integer, primary_key=True, index=True)
    woocommerce_payment_method_id = Column(String(20), index=True)
    woocommerce_payment_method_name = Column(String(255), index=True, nullable=True)
    odoo_journal_id = Column(Integer, index=True)
    odoo_journal_name = Column(String(255), index=True, nullable=True)
    odoo_journal_type = Column(String(50), nullable=True)
    odoo_journal_code = Column(String(50), nullable=True)
