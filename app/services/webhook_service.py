...
class WebhookService:
    ...
    def create_webhook_in_woocommerce(
        ...
        try:
            ...
            if response:
                logger.info(
                    f"Successfully created webhook {response.get('id')} in WooCommerce")
                return response
            else:
    ...
    def test_webhook_delivery(
        ...
        try:
            ...
            logger.info(
                f"Webhook test result: {result.message}, {result.response_time_ms}ms")
    ...
    def sync_webhook_to_woocommerce(
        ...
        try:
            ...
            if webhook.wc_webhook_id:
                ...
                wc_response = self.create_webhook_in_woocommerce(
                    wcapi, webhook_data)
