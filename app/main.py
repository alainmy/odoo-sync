...
app.include_router(task_monitoring_router,
                   prefix="/api/v1/sync", tags=["task-monitoring"])
app.include_router(sync_management_router, prefix="/api/v1",
                   tags=["sync-management"])
app.include_router(category_tag_management_router,
                   prefix="/api/v1", tags=["category-tag-management"])
app.include_router(attributes_router, prefix="/api/v1", tags=["attributes"])
app.include_router(attributes_management_router,
                   prefix="/api/v1", tags=["attribute-management"])
app.include_router(instances_router, prefix="/api/v1", tags=["instances"])
app.include_router(pricelists_router,
                   prefix="/api/v1/pricelists", tags=["pricelists"])
app.include_router(
    webhooks_router, prefix="/api/v1/webhooks", tags=["webhooks"])
app.include_router(webhook_receiver_router,
                   prefix="/api/v1/webhook-receiver", tags=["webhook-receiver"])
app.include_router(
    delivery_methods, prefix="/api/v1/delivery_methods", tags=["DELIVERY"])
app.include_router(odoo_websites_router,
                   prefix="/api/v1/odoo-websites", tags=["odoo-websites"])
